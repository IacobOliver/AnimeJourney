...
export default function Search({costumClass}){
    ...
    const formatResult = (anime) => {
        return (
            <div className={`h-16 my-1 px-2 rounded-lg flex group-hover relative z-40`}>
                ...
                {/* <div className="h-full min-w-60  rounded-lg bg-center bg-cover p-2" style={{ backgroundImage: `url(${anime.images.jpg.image_url})` }}></div> */}
                <img className="rounded-xl max-w-[3.2rem]" src = {anime.images.jpg.image_url}/>

                <div className="text-fifth_color_theme w-5/6 text-left text-lg mx-2 mt-1">
                    <div className="font-fantasy tracking-wide w-5/6 truncate"><span>{anime.title}</span></div>
    ...
    return(
        <div className={` text-third_color_theme bg-black w-2/3 h-full rounded-2xl flex items-center ${costumClass} lg:w-[27rem] `}>

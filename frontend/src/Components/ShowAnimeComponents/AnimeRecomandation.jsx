...
export default function AnimeRecomandation() {
    ...
    return (
        ...
        <div className=" grid grid-cols-8 gap-4 text-fifth_color_theme mt-5 px-3">
            

            <p className="col-span-8 text-2xl sm:text-3xl font-fantasy ml-3">Recommended if you like this anime ♥</p>

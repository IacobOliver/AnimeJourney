    ...
    const AnimeCard = ({anime}) => {
        return (
            <div className=" h-16 my-2 rounded-lg flex">
                {/* <img className="h-full w-14 flex justify-center items-center rounded-lg" src={anime.images.jpg.image_url}/> */}
                <div className="h-full w-16 rounded-lg bg-center bg-cover p-2" style={{ backgroundImage: `url(${anime.images.jpg.image_url})` }}></div>

                <div className="text-fifth_color_theme ml-3 font-fantasy w-72">

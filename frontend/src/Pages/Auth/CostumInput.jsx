...
export default function CostumInput({placeHolder, reff}){
 return (
    <div className="w-full flex justify-center mb-2">
        <div className="relative h-10 w-2/3 min-w-[200px]">
          <input
            ref = {reff}
            className=" text-fifth_color_theme peer h-full w-full rounded-[7px] border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-forth_color_theme focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
            placeholder=" "
          />
